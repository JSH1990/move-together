...
public class Club {
    ...
    public void publish() {
        if (!this.closed && !this.published){
            ...
            throw new RuntimeException("클럽을 공개할 수 없는 상태입니다. 클럽을 이미 공개했거나 종료했습니다.");
        }
    }
    ...
    public void close() {
        if (!this.closed){
            ...
            throw new RuntimeException("클럽 종료할 수 없습니다. 클럽을 종료하지 않았거나 이미 종료된 클럽입니다.");
        }
    }
    ...
    public void startRecruit() {
        if (canUpdateRecruiting()){
            ...
            throw new RuntimeException("인원 모집을 시작할 수 없습니다. 클럽을 공개하거나 한 시간 뒤 다시 시도하세요.");
        }
    }
    ...
    public void stopRecruit() {
        if (canUpdateRecruiting()){
            ...
            throw new RuntimeException("인원 모집을 멈출 수 없습니다. 클럽을 공개하거나 한 시간 뒤 다시 시도하세요.");
        }
    }
